...
export default function TimelineManagement() {
  ...
  const handleSave = () => {
    if (editingIndex !== null) {
      updateTimelineItem(editingIndex, formData)
    } else {
      addTimelineItem(formData)
    }
  ...
  const moveItem = (index, direction) => {
    ...
    const item = newTimeline[index]
    
    if (direction === 'up' && index > 0) {
      newTimeline[index] = newTimeline[index - 1]
      newTimeline[index - 1] = item
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button onClick={handleAddItem} className="btn-primary enhanced-glow">
                ...
                <div className="flex items-center gap-4">
                  <div className="flex flex-col items-center">
                    ...
                    {index < data.timeline.length - 1 && (
                      <div className="w-0.5 h-8 bg-gradient-to-b from-primary to-transparent mt-2"></div>
                    )}
                  </div>
      ...
      {/* نافذة إضافة/تعديل العنصر */}
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle>
              {editingIndex !== null ? 'تعديل العنصر' : 'إضافة عنصر جديد'}
            </DialogTitle>
            <DialogDescription>
              {editingIndex !== null ? 'قم بتعديل بيانات العنصر' : 'أدخل بيانات العنصر الجديد'}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2 pt-4">
              <Button onClick={handleSave} className="btn-primary enhanced-glow">
                {editingIndex !== null ? 'حفظ التغييرات' : 'إضافة العنصر'}
              </Button>
